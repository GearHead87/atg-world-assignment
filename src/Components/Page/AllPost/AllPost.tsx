...
import { FaEllipsis, FaLocationDot, FaPen } from 'react-icons/fa6';
const allPost = [
	{
		_id: 1,
			...
			<div className="row p-md-0">
					...
					<div className="d-flex align-items-center justify-content-between p-3">
						...
						<div>
							<button className="filter-btn btn border-0">
								Filter: All <BsCaretDownFill className=" ps-3" />
							</button>
						</div>
					</div>
				</div>
					...
					<div className="d-flex align-items-center justify-content-between pt-4 ">
						...
						<div className="pb-2">
							<button className=" me-3 btn-post">
								Write a Post{' '}
								<BsCaretDownFill className="fa-solid fa-caret-down ps-2"></BsCaretDownFill>
							</button>
							<button className=" btn-join">
								+<GrGroup className="fa-solid fa-user-group " /> Join Group
							</button>
						</div>
					</div>
							...
							<div className="card-body">
								...
								<div className="d-flex justify-content-between">
									...
									<div className="px-2 position-relative">
										...
										>
											<FaEllipsis className="fa-solid fa-ellipsis fs-3" />
										</button>
										{show && (
								...
								<div className="d-flex align-items-center my-2">
									{post.postDate && (
										<h6 className="me-5">
											<BsCalendar2DayFill className="fa-solid fa-calendar-day" />{' '}
											{post.postDate}
										</h6>
									)}
									{post.postCompany && (
										<>
											<h6 className="me-5 d-lg-none">
												<BsBriefcaseFill className="fa-solid fa-briefcase me-1" />
								...
								{/* POST NOW BUTTON */}
								<a href="" id="post-now">
									<BsPenFill className="fa-solid fa-pen" />
								</a>
								{/* SIGN UP MODAL */}
								<div
								...
								<div className="pt-4 pb-1 d-flex align-items-center justify-content-between">
									...
									<div className="d-flex align-items-center ">
										<div className="d-none d-lg-block">
											<BsEyeFill className="fa-solid fa-eye me-2" />{' '}
											{post.postView}
										</div>
										<button className="share-btn ms-5 me-2">
											<BsShareFill className="fa-solid fa-share-nodes" />
										</button>
									</div>
								</div>
							</div>
				...
				<div className="col-md-4 ps-5 d-none d-lg-block">
					<div className="d-flex align-items-center justify-content-between mt-5">
						<div>
							<h5>
								<FaLocationDot className="fa-solid fa-location-dot"></FaLocationDot>{' '}
								Noida, India
							</h5>
						</div>
						<div>
					...
					<div className="d-flex mt-5">
						<div className="me-2">
							<BsInfoCircleFill className="fa-solid fa-circle-info text-secondary" />
						</div>
						<div>
					...
					<div>
						<h5 className="mt-5">
							<BsHandThumbsUpFill className="fa-solid fa-thumbs-up" /> Recommended
							Groups
						</h5>
						<div className="mt-3">
